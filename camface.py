...
with picamera.PiCamera() as camera:
    ...
    # path = '/home/pi/samples_matsunaga/opencv/data/'

	# 顔検出のための学習元データを読み込む
	face_cascade = cv.CascadeClassifier('/home/pi/samples_matsunaga/opencv/data/haarcascades/haarcascade_frontalface_default.xml')
	# 目検出のための学習元データを読み込む
	eye_cascade = cv.CascadeClassifier('/home/pi/samples_matsunaga/opencv/data/haarcascades/haarcascade_eye.xml')
	# 顔検出を行う
